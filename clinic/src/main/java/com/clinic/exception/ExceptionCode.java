...
public class ExceptionCode {
     ...
     * 便利店手机号码为空
     */
    public static final int SHOP_PHONE_IS_NULL = 99;
    
    /**
     * 便利店手机号码格式不对
     */
    public static final int SHOP_PHONE_FOMAT_ERROR = 100;
    
    /**
     * 便利店营业信息ID不能为空
     */
    public static final int SHOP_BUSINESS_ID_IS_NULL = 98;
    
    /** 没有找到便利店营业信息 */
    public static final int SHOP_BUSINESS_IS_NOT_FIND = 99;
    
    /**
     * 便利店分类名称为空
     */
    public static final int SHOP_CATEGORY_NAME_IS_NULL = 100;
